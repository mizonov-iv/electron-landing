...
<!--        <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="13" aria-label="Slide 3"></button>-->
      ...
      <div class="carousel-inner" style="">
        <div class="carousel-item active">
          <img src="/img/portfolio/1.jpg" class="slider-img" alt="slide">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/2.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/3.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/4.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/5.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/6.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/7.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/8.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
          <img src="/img/portfolio/9.jpg" class="slider-img" alt="...">
        </div>
        <div class="carousel-item">
